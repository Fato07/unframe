/**
 * CodesDevs Generation Script
 * 
 * Generates a complete Next.js project from CodesDevs.io Framer data.
...
import { parseProjectXml, parseNodeXml } from '@unframe/core'
import { createASTBuilder } from '@unframe/core'
import { scaffoldNextjsProject } from '@unframe/core'

// Real data from CodesDevs.io (same as integration tests)
const PROJECT_XML = `
<Project>
  <Pages>
      ...
      >
        ...
        >
          ...
          <SecondaryButton
              ...
              stackAlignment="center"
          >
            <ButtonText nodeId="btn2txt" inlineTextStyle="/Body (M)">
              Learn More
            </ButtonText>
          </SecondaryButton>
        </CTAButtons>
